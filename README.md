...
|               캘린더                |         장바구니 드래그 앤 드롭          |
| :---------------------------------: | :--------------------------------------: |
| <img src="./etc/todo_calendar.png"> | <img src="./etc/todo_calendar_drag.gif"> |

|             할일 생성             |               날짜 선택                |               목표 선택                |
| :-------------------------------: | :------------------------------------: | :------------------------------------: |
| <img src="./etc/create_todo.png"> | <img src="./etc/create_todo_date.png"> | <img src="./etc/create_todo_goal.png"> |
...
|         목표 조회          |            목표 수정            |          노트 모아보기          |
| :------------------------: | :-----------------------------: | :-----------------------------: |
| <img src="./etc/goal.png"> | <img src="./etc/goal_edit.png"> | <img src="./etc/goal_note.png"> |

|               할일 생성                |             장바구니 date picker             |
| :------------------------------------: | :------------------------------------------: |
| <img src="./etc/goal_create_todo.png"> | <img src="./etc/goal_basket_datepicker.png"> |
...
| :-------------------------------: | :------------------------------------: |
| <img src="./etc/note_create.png"> | <img src="./etc/note_create_save.png"> |

|            링크 임베드 가능             |          링크 임베드 제공 안될 시          |
| :-------------------------------------: | :----------------------------------------: |
| <img src="./etc/note_create_embed.png"> | <img src="./etc/note_create_no_embed.png"> |

|         노트 조회 모달창         |        노트 모달창 링크 임베드         |
| :------------------------------: | :------------------------------------: |
| <img src="./etc/note_modal.png"> | <img src="./etc/note_modal_embed.png"> |
...
| :------------------------------------: | :-------------------------------------: | :-------------------------------------: |
| <img src="./etc/theme_light_pink.png"> | <img src="./etc/theme_light_green.png"> | <img src="./etc/theme_dark_purple.png"> |
